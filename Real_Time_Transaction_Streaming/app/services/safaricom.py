...
class DarajaService:
    ...
    async def register_c2b_callback(self, confirmation_url: str, validation_url: str) -> Dict[str, Any]:
        """
    ...
    async def initiate_stk_push(
        ...
        phone_number: str,
        amount: float,
        account_reference: str = "ChamaNdoto"
    ) -> Dict[str, Any]:
        """
            ...
            async with httpx.AsyncClient() as client:
                response = await client.post(
                    ...
                    json={
                        ...
                        'PartyA': phone_number,
                        'IdentifierType': '1',
                        'ResultURL': f"https://{settings.DOMAIN}/api/v1/webhooks/status/callback",
                        'QueueTimeOutURL': f"https://{settings.DOMAIN}/api/v1/webhooks/status/timeout",
